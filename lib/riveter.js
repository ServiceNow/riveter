...
(function (root, factory) {
	...
	riveter.inherits = function (child, parent, ctorProps) {
		...
		_.assign(Child.prototype, childProto, {
			constructor: Child
		});
	...
	riveter.compose = function () {
		...
		var res = ctor.extend({
			constructor: function ( /* options */ ) {
				var args = slice.call(arguments, 0);
				_.forEach(mixin.preInit, function (initializer) {
					initializer.apply(this, args);
				}, this);
				ctor.prototype.constructor.apply(this, args);
				_.forEach(mixin.postInit, function (initializer) {
					initializer.apply(this, args);
				}, this);
			}
		});
		riveter.rivet(res);
		_.defaults(res.prototype, _.assign.apply(null, [{}].concat(mixin.items)));
		return res;
	};
	riveter.mixin = function () {
		...
		var ctor = args.shift();
		riveter.rivet(ctor);
		_.defaults(ctor.prototype, _.assign.apply(null, [{}].concat(args)));
	};
	return riveter;
}));